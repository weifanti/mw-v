...
cfg_reg tas5825_gpio_012_confgi[] ={
   ...
   { 0x60, 0x7 },   // set gpio 0 as out put , amp_fualt
   					 // set gpio 1 as input, mute pin
   					 // set gpio 2 as out put, amp warn.

   
    {0x65,0x07}	, // gpio1 as amp mute
   	{0x61,0x02},  // gpio as amp fault
   	{0x62,0x02},  // gpio2 as amp warn
   	{0x63,0x02},   // gpio1 as amp mute
   	
   };  


   cfg_reg tas5825_gpio_012_confgi_low[] ={
...
{
	GPIO_SetMode(PD, BIT10, GPIO_MODE_INPUT);	
...
void drv_5825_gpio012_config(void)
{
	...
	Hal_I2c_Transfer(DAP1_I2C_ADDR, (uint8_t*)tas5825_gpio_012_confgi_low, sizeof(tas5825_gpio_012_confgi)/2, (uint8_t*)NULL, 0);

	drv_5825_01_i2c_write(tas5825_book0_page0,sizeof(tas5825_book0_page0)/2);
	Hal_I2c_Transfer(DAP2_I2C_ADDR, (uint8_t*)tas5825_gpio_012_confgi_low, sizeof(tas5825_gpio_012_confgi)/2, (uint8_t*)NULL, 0);
