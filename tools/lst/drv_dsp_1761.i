...
#line 10 "..\\src\\driver\\drv_dsp_1761.c"
...
#line 11 "..\\src\\driver\\drv_dsp_1761.c"
#line 12 "..\\src\\driver\\drv_dsp_1761.c"
...
#line 13 "..\\src\\driver\\drv_dsp_1761.c"

#line 1 "..\\src\\driver\\include\\drv_dsp_1761.h"
...
#line 15 "..\\src\\driver\\drv_dsp_1761.c"
...
#line 16 "..\\src\\driver\\drv_dsp_1761.c"
...
#line 30 "..\\src\\driver\\drv_dsp_1761.c"
...
static void Hal_Dsp_Load_Part_0(void)
{
    ...
    for(idx = 0; idx < (sizeof(mt0)/sizeof(init_arr_matrix_t)); idx++)
    {
        Hal_I2c1_Transfer((0x70), mt0[idx].arr_ptr, mt0[idx].arr_len, (uint8_t*)0, 0);
    }
}
...
static void Hal_Dsp_Load_Part_1(void)
{
    ...
    for(idx = 0; idx < (sizeof(mt1)/sizeof(init_arr_matrix_t)); idx++)
    {
        Hal_I2c1_Transfer((0x70), mt1[idx].arr_ptr, mt1[idx].arr_len, (uint8_t*)0, 0);
    }
...
static void Hal_Dsp_Safeload(uint8_t* word_arr, uint8_t word_num, uint16_t target_addr)
{
    uint8_t temp_arr[((0x0007) - (0x0001) + 1) * (4) + 2];
    int cnt;
    ...
    temp_arr[0] = (uint8_t)(((0x0001) >> 8) & 0xFF);
    temp_arr[1] = (uint8_t)((0x0001) & 0xFF);
    ...
    cnt = ((0x0007) - (0x0001)) * (4) + 5;
    temp_arr[cnt] = (uint8_t)(word_num & 0xFF);

     
    cnt = sizeof(temp_arr);
    Hal_I2c1_Transfer((0x70), temp_arr, cnt, (uint8_t*)0, 0);
}
...
void Hal_Dsp_Vol_Set(uint8_t vol_step)
{
    if(vol_step > ((sizeof(vol_table)/sizeof(param_word_t)) - 1))
    {
        return;
    }

     
    Hal_Dsp_Safeload((uint8_t*)&(vol_table[vol_step]), 1, (0x0009));
}
...
void Hal_Dsp_channel_Set(uint8_t channel)
{
    ...
    Hal_Dsp_Safeload((uint8_t*)arr_aux_channel, 1, (0x0008));
}
...
void Hal_Dsp_Audio_Stream_Sw(dsp_audio_stream_e audio_stream)
{
    ...
    Hal_Dsp_Safeload((uint8_t*)&(stream_table[audio_stream]), 1, (0x0008));
}
