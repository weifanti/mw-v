...
typedef struct
{
    ...
    uint16_t                       curr_tx_pos;   
    uint16_t                       curr_rx_pos;   
    uint16_t                       wait_cnt;      
    uint8_t                        slave_addr;    
    i2c_bus_status_e               next_status;   
    _Bool                           is_in_trans;   

} i2c_trans_data_t;

volatile static i2c_trans_data_t i2c_trans_data;       
...
void Hal_I2c_Init(void)
{
    ...
    I2C_Open(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), (200000UL));
    ...
    SYS_ResetModule(((0x4<<24)|(9)));
    I2C_EnableTimeout(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 1);
    I2C_Open(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), (100000UL));
...
static void Hal_I2c1_Stop(void)
{
    ...
    I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0, 1, 1, 0);
    i2c_trans_data.wait_cnt    = 0;
    i2c_trans_data.is_in_trans = 0;
}
...
void Hal_I2c_Transfer(uint8_t addr, uint8_t* tx_arr, uint32_t tx_len, uint8_t* rx_arr, uint32_t rx_len)
{
    ...
    if(I2C_GetStatus(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))) == I2C_STATUS_ERROR)
    {
...
void Hal_I2c1_Transfer(uint8_t addr, uint8_t* tx_arr, uint32_t tx_len, uint8_t* rx_arr, uint32_t rx_len)
{
    ...
    if(I2C_GetStatus(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))) == I2C_STATUS_ERROR)
    {
    ...
    I2C_ClearTimeoutFlag(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)));
    I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 1, 0, 1, 0);
...
void I2C0_IRQHandler(void)
{
	...
	status = ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->STATUS);

    NVIC_ClearPendingIRQ(I2C0_IRQn);

    if(( ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->TOCTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1 : 0 ))
    {
        I2C_ClearTimeoutFlag(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
        Hal_I2c0_Stop();
        return;
    ...
    if(i2c_trans_data.next_status != status)
    {
        ...
        if(i2c_trans_data.wait_cnt > (5000))
        {
            if((sys_err & SYS_ERR_I2C0) == 0)
            {
                sys_err |= SYS_ERR_I2C0;
    ...
    switch (status)
    {
        ...
        case I2C_STATUS_START_OK:
            ...
            i2c_trans_data.wait_cnt = 0;
            I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), i2c_trans_data.slave_addr | I2C_DIR_WRITE);
            I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
            break;

         
        case I2C_STATUS_TRANS_ADDR_ACK:
			TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 16);	
            if(i2c_trans_data.tx_buff_len)
            {
                i2c_trans_data.next_status = I2C_STATUS_TRANS_DATA_ACK;
                i2c_trans_data.wait_cnt = 0;
                I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), i2c_trans_data.p_tx_buff[0]);
        ...
        case I2C_STATUS_TRANS_DATA_ACK:
            ...
            if(tmp < i2c_trans_data.tx_buff_len)
            {
                i2c_trans_data.next_status = I2C_STATUS_TRANS_DATA_ACK;
                i2c_trans_data.wait_cnt = 0;
                I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), i2c_trans_data.p_tx_buff[tmp]);
        ...
        case I2C_STATUS_REPEAT_START_OK:
            if(i2c_trans_data.rx_buff_len)
            {
                ...
                i2c_trans_data.wait_cnt = 0;
                I2C_SetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), i2c_trans_data.slave_addr | I2C_DIR_READ);
                I2C_Trigger(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0, 1, 0);
            }
            else
            {
        ...
        case I2C_STATUS_REC_DATA_ACK:
            ...
            if(tmp < i2c_trans_data.rx_buff_len)
            {
                ...
                i2c_trans_data.wait_cnt = 0;
                tp[tmp] = (uint8_t)(I2C_GetData(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))) & 0xFF);
...
void I2C1_IRQHandler(void)
{
    ...
    status = ((((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)))->STATUS);

    NVIC_ClearPendingIRQ(I2C1_IRQn);

    if(( ((((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)))->TOCTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1 : 0 ))
    {
        I2C_ClearTimeoutFlag(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)));
        Hal_I2c1_Stop();
        return;
    ...
    switch (status)
    {
        ...
        case I2C_STATUS_START_OK:
            i2c_trans_data.next_status = I2C_STATUS_TRANS_ADDR_ACK;
            i2c_trans_data.wait_cnt = 0;
            I2C_SetData(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), i2c_trans_data.slave_addr | I2C_DIR_WRITE);
            I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0, 0, 1, 0);
            break;
        ...
        case I2C_STATUS_TRANS_ADDR_ACK:
            if(i2c_trans_data.tx_buff_len)
            {
                i2c_trans_data.next_status = I2C_STATUS_TRANS_DATA_ACK;
                i2c_trans_data.wait_cnt = 0;
                I2C_SetData(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), i2c_trans_data.p_tx_buff[0]);
                i2c_trans_data.curr_tx_pos = 1;
                I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0, 0, 1, 0);
            }
            else
        ...
        case I2C_STATUS_TRANS_DATA_ACK:
            ...
            if(tmp < i2c_trans_data.tx_buff_len)
            {
                i2c_trans_data.next_status = I2C_STATUS_TRANS_DATA_ACK;
                i2c_trans_data.wait_cnt = 0;
                I2C_SetData(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), i2c_trans_data.p_tx_buff[tmp]);
                i2c_trans_data.curr_tx_pos++;
                I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0, 0, 1, 0);
            }
            else if(i2c_trans_data.rx_buff_len)
        ...
        case I2C_STATUS_REPEAT_START_OK:
            if(i2c_trans_data.rx_buff_len)
            {
                i2c_trans_data.next_status = I2C_STATUS_REC_ADDR_ACK;
                i2c_trans_data.wait_cnt = 0;
                I2C_SetData(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), i2c_trans_data.slave_addr | I2C_DIR_READ);
                I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0, 0, 1, 0);
            }
            else
            {
        ...
        case I2C_STATUS_REC_ADDR_ACK:
            if(i2c_trans_data.rx_buff_len)
            {
                ...
                {
                    I2C_Trigger(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0, 0, 1, 1);
                }
            }
            else
            {
        ...
        case I2C_STATUS_REC_DATA_ACK:
            ...
            if(tmp < i2c_trans_data.rx_buff_len)
            {
                ...
                i2c_trans_data.wait_cnt = 0;
                tp[tmp] = (uint8_t)(I2C_GetData(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000))) & 0xFF);
                i2c_trans_data.curr_rx_pos++;
