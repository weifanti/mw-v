...
#line 14 "..\\src\\driver\\drv_gpio_key.c"
...
#line 15 "..\\src\\driver\\drv_gpio_key.c"
...
#line 16 "..\\src\\driver\\drv_gpio_key.c"
...
#line 17 "..\\src\\driver\\drv_gpio_key.c"
...
#line 18 "..\\src\\driver\\drv_gpio_key.c"
...
unsigned char IoKeyInputmessage = 0;

void drv_gipo_key_init(void)
{

	GPIO_SetMode(((GPIO_T *) (((( unsigned int)0x50000000) + 0x4000) + 0x0080)), 0x00000008,  0x0UL); 
	GPIO_SetMode(((GPIO_T *) (((( unsigned int)0x50000000) + 0x4000) + 0x0080)), 0x00000040,  0x0UL); 
	HwKeyScanInit();
...
static const unsigned char SoftwareKeyEvent[][3] = 
	{
...
void GetKeyEvent(void)							
{
	static 	unsigned char 	PreKeyIndex = 0;
	...
	if(!(*((volatile unsigned int *)(((((( unsigned int)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((3)<<2)))))
	{
		KeyIndex = 1;
	}
	else if(!(*((volatile unsigned int *)(((((( unsigned int)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((6)<<2)))))
	{	
		KeyIndex = 2;
