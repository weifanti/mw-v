...
#line 11 "..\\src\\driver\\drv_pga460.c"
...
#line 12 "..\\src\\driver\\drv_pga460.c"
...
#line 13 "..\\src\\driver\\drv_pga460.c"
...
#line 14 "..\\src\\driver\\drv_pga460.c"
...
#line 15 "..\\src\\driver\\drv_pga460.c"
...
#line 16 "..\\src\\driver\\drv_pga460.c"
#line 1 "..\\src\\driver\\include\\drv_pga460.h"
...
#line 17 "..\\src\\driver\\drv_pga460.c"
...
void drv_FourGmodel_power_key_down(void);
void drv_FourGmodel_power_key_up(void);

#line 18 "..\\src\\driver\\drv_pga460.c"
...
#line 19 "..\\src\\driver\\drv_pga460.c"
...
#line 49 "..\\src\\driver\\drv_pga460.c"


#line 60 "..\\src\\driver\\drv_pga460.c"


 
#line 80 "..\\src\\driver\\drv_pga460.c"


#line 91 "..\\src\\driver\\drv_pga460.c"

 
#line 110 "..\\src\\driver\\drv_pga460.c"


#line 121 "..\\src\\driver\\drv_pga460.c"


#line 143 "..\\src\\driver\\drv_pga460.c"

#line 151 "..\\src\\driver\\drv_pga460.c"

#line 169 "..\\src\\driver\\drv_pga460.c"

#line 186 "..\\src\\driver\\drv_pga460.c"

#line 203 "..\\src\\driver\\drv_pga460.c"

 



uint8_t pga460_data_buf[(128) + 2] = {0};
...
{
    static uint8_t ChecksumInput[44]; 
    ...
    switch(cmd)
    {
        ...
        case 24 : 
            ChecksumInput[0] = cmd;
            ChecksumInput[1] = (0x44);
            ChecksumInput[2] = (0x44);
            ChecksumInput[3] = (0xCD);
            ChecksumInput[4] = (0x08);
            ChecksumInput[5] = (0x64);
            ChecksumInput[6] = (0xBF);
            ChecksumInput[7] = (0xFC);
            checksumLoops = 8;
        break;
        case 16 : 
        case 25 : 
            ChecksumInput[0]  = cmd;
            ChecksumInput[1]  = (0x88);
            ChecksumInput[2]  = (0xA9);
            ChecksumInput[3]  = (0xA0);
            ChecksumInput[4]  = (0x88);
            ChecksumInput[5]  = (0x88);
            ChecksumInput[6]  = (0x88);
            ChecksumInput[7]  = (0xFF);
            ChecksumInput[8]  = (0xCE);
            ChecksumInput[9]  = (0x73);
            ChecksumInput[10] = (0xFF);
            ChecksumInput[11] = (0xFF);
            ChecksumInput[12] = (0xFF);
            ChecksumInput[13] = (0xFF);
            ChecksumInput[14] = (0xFF);
            ChecksumInput[15] = (0xFF);
            ChecksumInput[16] = (0x07);
            ChecksumInput[17] = (0xB0);
            ChecksumInput[18] = (0x88);
            ChecksumInput[19] = (0x88);
            ChecksumInput[20] = (0x88);
            ChecksumInput[21] = (0x88);
            ChecksumInput[22] = (0x88);
            ChecksumInput[23] = (0xFB);
            ChecksumInput[24] = (0xDE);
            ChecksumInput[25] = (0xF7);
            ChecksumInput[26] = (0xBD);
            ChecksumInput[27] = (0xEF);
            ChecksumInput[28] = (0x7F);
            ChecksumInput[29] = (0x7F);
            ChecksumInput[30] = (0x7F);
            ChecksumInput[31] = (0x7F);
            ChecksumInput[32] = (0x07);
            checksumLoops = 33;
        break;
        case 12 : 
        case 23 : 
            ...
            ChecksumInput[2] = (0x00);
            ChecksumInput[3] = (0x00);
            ChecksumInput[4] = (0x00);
            ChecksumInput[5] = (0x00);
            ChecksumInput[6] = (0x00);
            ChecksumInput[7] = (0x00);
            ChecksumInput[8] = (0x00);
            ChecksumInput[9] = (0x00);
            ChecksumInput[10] = (0x00);
            ChecksumInput[11] = (0x00);
            ChecksumInput[12] = (0x00);
            ChecksumInput[13] = (0x00);
            ChecksumInput[14] = (0x00);
            ChecksumInput[15] = (0x00);
            ChecksumInput[16] = (0x00);
            ChecksumInput[17] = (0x00);
            ChecksumInput[18] = (0x00);
            ChecksumInput[19] = (0x00);
            ChecksumInput[20] = (0x00);
            ChecksumInput[21] = (0x44);
            ChecksumInput[22] = (0x44);
            ChecksumInput[23] = (0xCD);
            ChecksumInput[24] = (0x08);
            ChecksumInput[25] = (0x64);
            ChecksumInput[26] = (0xBF);
            ChecksumInput[27] = (0xFC);
            ChecksumInput[28] = (0x40);
            ChecksumInput[29] = (0x32);
            ChecksumInput[30] = (0x00);
            ChecksumInput[31] = (0x07);
            ChecksumInput[32] = (0x10);
            ChecksumInput[33] = (0x7F);
            ChecksumInput[34] = (0x10);
            ChecksumInput[35] = (0x17);
            ChecksumInput[36] = (0x33);
            ChecksumInput[37] = (0xEE);
            ChecksumInput[38] = (0x7C);
            ChecksumInput[39] = (0x4F);
            ChecksumInput[40] = (0x00);
            ChecksumInput[41] = (0x00);
            ChecksumInput[42] = (0x00);
            ChecksumInput[43] = (0x00);
            checksumLoops = 44;
        break;
        default:
        break;
...
void drv_Pga460_Thresholds_Init(void)
{
    uint16_t buff_len = (32) + 3;
    uint8_t  crc_val  = 0;

    uint8_t tmp_buf[(32) + 3] =
    {
        (0x55),
        (0x10),
        (0x88),
    ...
    crc_val = pga460_calcChecksum((0x10));
...
void drv_Pga460_Default_Set(void)
{
    uint16_t buff_len = (43) + 3;
    uint8_t  crc_val  = 0;

    uint8_t tmp_buf[(43) + 3] =
    {
        (0x55),
        (0x0C),
        (0x00),
    ...
    crc_val = pga460_calcChecksum((0x0C));
    tmp_buf[buff_len - 1] = crc_val;
...
void drv_Pga460_Tvg_Init(void)
{
    uint16_t buff_len = (2) + 3;
    uint8_t  crc_val  = 0;

    uint8_t tmp_buf_0[(2) + 3] =
    {
        (0x55),
        (0x0A),
        (0x26),
    ...
    crc_val = pga460_calcChecksum((0x0A));
    ...
    crc_val = pga460_calcChecksum((0x0E));
...
void drv_Pga460_Obj_P1_Det(void)
{
    uint16_t buff_len = (1) + 3;
    uint8_t  crc_val  = 0;
    uint8_t tmp_buf_0[(1) + 3] =
    {
        (0x55),
        (0x00),
        (1),
    ...
    crc_val = pga460_calcChecksum((0x00));
    ...
    buff_len = (0) + 3;
    crc_val  = pga460_calcChecksum((0x07));
	
    tmp_buf_1[buff_len - 1] = crc_val;
    Hal_Uart2_Write(tmp_buf_1, buff_len);

     
	TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 25000);
	buff_len = (128) + 2;
...
void drv_Pga460_Obj_P2_Det(void)
{
    ...
    crc_val = pga460_calcChecksum((0x01));
...
#line 776 "..\\src\\driver\\drv_pga460.c"
}
...
void drv_Pga460_read_data(void)
{
    ...
    crc_val = pga460_calcChecksum((0x0B));
	tmp_buf_0[2]=	crc_val;
