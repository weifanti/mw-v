#line 1 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
#line 10 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
#line 11 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
#line 12 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
#line 13 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
void drv_5825_mute_pin_set(uint8_t value);  

void drv_5825_gpio012_config(void);



#line 14 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
#line 1 "..\\src\\driver\\audio\\drv_dap_tas5825_param.h"
...
#line 15 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
#line 16 "..\\src\\driver\\audio\\drv_dap_tas5825.c"
...
{ 
	...
	{0x0c, 0x00, 0x00, 0x20, 0xc5},  
	{0x0c, 0x00, 0x00, 0x67, 0x9f},  
	{0x0c, 0x00, 0x01, 0x47, 0xae},  
	{0x0c, 0x00, 0x04, 0x0c, 0x37},   
	{0x0c, 0x00, 0x07, 0x32, 0xae},  
	{0x0c, 0x00, 0x0c, 0xcc, 0xcd},   
	{0x0c, 0x00, 0x16, 0xc3, 0x11},   
	{0x0c, 0x00, 0x28, 0x7a, 0x27},   
	{0x0c, 0x00, 0x32, 0xf5, 0x2d},   
	{0x0c, 0x00, 0x40, 0x26, 0xe7},   
	{0x0c, 0x00, 0x50, 0xc3, 0x36},   
	{0x0c, 0x00, 0x65, 0xac, 0x8c},   
	{0x0c, 0x00, 0x80, 0x00, 0x00},   
	{0x0c, 0x00, 0xa1, 0x24, 0x78},   
	{0x0c, 0x00, 0xca, 0xdd, 0xc8},   
	{0x0c, 0x00, 0xff, 0x64, 0xc1},   
	{0x0c, 0x01, 0x41, 0x85, 0x7f},   
...
{ 
	...
	{0x10, 0x00, 0x00, 0x20, 0xc5},  
	{0x10, 0x00, 0x00, 0x67, 0x9f},  
	{0x10, 0x00, 0x01, 0x47, 0xae},  
	{0x10, 0x00, 0x04, 0x0c, 0x37},   
	{0x10, 0x00, 0x07, 0x32, 0xae},  
	{0x10, 0x00, 0x0c, 0xcc, 0xcd},   
	{0x10, 0x00, 0x16, 0xc3, 0x11},   
	{0x10, 0x00, 0x28, 0x7a, 0x27},   
	{0x10, 0x00, 0x32, 0xf5, 0x2d},   
	{0x10, 0x00, 0x40, 0x26, 0xe7},   
	{0x10, 0x00, 0x50, 0xc3, 0x36},   
	{0x10, 0x00, 0x65, 0xac, 0x8c},   
	{0x10, 0x00, 0x80, 0x00, 0x00},   
	{0x10, 0x00, 0xa1, 0x24, 0x78},   
	{0x10, 0x00, 0xca, 0xdd, 0xc8},   
	{0x10, 0x00, 0xff, 0x64, 0xc1},   
	{0x10, 0x01, 0x41, 0x85, 0x7f},   
...
{ 
	...
	{0x0c, 0x00, 0x00, 0x10, 0x6c},  
	{0x0c, 0x00, 0x00, 0x33, 0xef},  
	{0x0c, 0x00, 0x00, 0xa4, 0x3b},  
	{0x0c, 0x00, 0x02, 0x07, 0x56},   
	{0x0c, 0x00, 0x03, 0x9b, 0x87},  
	{0x0c, 0x00, 0x06, 0x6a, 0x4a},   
	{0x0c, 0x00, 0x0b, 0x68, 0x73},   
	{0x0c, 0x00, 0x14, 0x49, 0x61},   
	{0x0c, 0x00, 0x19, 0x8a, 0x13},   
	{0x0c, 0x00, 0x20, 0x26, 0xf3},   
	{0x0c, 0x00, 0x28, 0x7a, 0x27},   
	{0x0c, 0x00, 0x32, 0xf5, 0x2d},   
	{0x0c, 0x00, 0x40, 0x26, 0xe7},   
	{0x0c, 0x00, 0x50, 0xc3, 0x36},   
...
{ 
	...
	{0x10, 0x00, 0x00, 0x10, 0x6c},  
	{0x10, 0x00, 0x00, 0x33, 0xef},  
	{0x10, 0x00, 0x00, 0xa4, 0x3b},  
	{0x10, 0x00, 0x02, 0x07, 0x56},   
	{0x10, 0x00, 0x03, 0x9b, 0x87},  
	{0x10, 0x00, 0x06, 0x6a, 0x4a},   
	{0x10, 0x00, 0x0b, 0x68, 0x73},   
	{0x10, 0x00, 0x14, 0x49, 0x61},   
	{0x10, 0x00, 0x19, 0x8a, 0x13},   
	{0x10, 0x00, 0x20, 0x26, 0xf3},   
	{0x10, 0x00, 0x28, 0x7a, 0x27},   
	{0x10, 0x00, 0x32, 0xf5, 0x2d},   
	{0x10, 0x00, 0x40, 0x26, 0xe7},   
	{0x10, 0x00, 0x50, 0xc3, 0x36},   
...
static void drv_5825_00_i2c_write(cfg_reg *r, int n)
{
    ...
    while (i < n) {
        ...
        case (253):
			...
			Hal_I2c_Transfer((0x9A), (unsigned char *)&r[i+1],  r[i].param, (uint8_t*)0, 0);
            i += (r[i].param + 1)/2;
            break;
        default:
			
			Hal_I2c_Transfer((0x9A), (uint8_t *)&r[i], 2, (uint8_t*)0, 0);
...
static void drv_5825_01_i2c_write(cfg_reg *r, int n)
{
    ...
    while (i < n) {
        ...
        case (253):
			...
			Hal_I2c_Transfer((0x98), (unsigned char *)&r[i+1],  r[i].param, (uint8_t*)0, 0);
            i += (r[i].param + 1)/2;
            break;
        default:
			
			Hal_I2c_Transfer((0x98), (uint8_t *)&r[i], 2, (uint8_t*)0, 0);
...
void drv_5825_vol_set(uint8_t value)
{
	...
	Hal_I2c_Transfer((0x9A), (uint8_t*)tas5825_volume0c[value], 5, (uint8_t*)0, 0);
	Hal_I2c_Transfer((0x9A), (uint8_t*)tas5825_volume10[value], 5, (uint8_t*)0, 0);
	drv_5825_01_i2c_write(tas5852_volume_page,sizeof(tas5852_volume_page)/2);
	Hal_I2c_Transfer((0x98), (uint8_t*)tas5825_volume0c[value], 5, (uint8_t*)0, 0);
	Hal_I2c_Transfer((0x98), (uint8_t*)tas5825_volume10[value], 5, (uint8_t*)0, 0);
...
void drv_5825_vol_set_wifi_bt(uint8_t value)
{
	...
	drv_5825_00_i2c_write(tas5852_volume_page,sizeof(tas5852_volume_page)/2);
	Hal_I2c_Transfer((0x9A), (uint8_t*)tas5825_volume0c_wifi_bt[value], 5, (uint8_t*)0, 0);
	Hal_I2c_Transfer((0x9A), (uint8_t*)tas5825_volume10_wifi_bt[value], 5, (uint8_t*)0, 0);
	drv_5825_01_i2c_write(tas5852_volume_page,sizeof(tas5852_volume_page)/2);
	Hal_I2c_Transfer((0x98), (uint8_t*)tas5825_volume0c_wifi_bt[value], 5, (uint8_t*)0, 0);
	Hal_I2c_Transfer((0x98), (uint8_t*)tas5825_volume10_wifi_bt[value], 5, (uint8_t*)0, 0);
...
{
	if(value)
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(3))) + ((10)<<2)))) = 1;
	else
		
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(3))) + ((10)<<2)))) = 0;
}
...
void drv_5825_powerdown_pin_set(uint8_t val)
{
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)), 0x00001000, 0x1UL);	
	if(val)
	{
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(3))) + ((12)<<2)))) = 1; 
	}
	else
	{
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(3))) + ((12)<<2)))) = 0; 
	}
}
...
void drv_5825_mute_pin_init(void)
{
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)), 0x00000400, 0x1UL);	
	drv_5825_mute_pin_set(0);  
}

void drv_5825_amp_fault_det_init(void)
{
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0140)), 0x00000004, 0x0UL);	
...
void drv_5825_amp_warn_det_init(void)
{
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)), 0x00000800, 0x0UL);	
}
