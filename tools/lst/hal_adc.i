...
uint32_t batlevel_table[11] = {1822,1924,2052,2120,2196,2219,2284,2339,2406,2457,2565};  
...
void hal_adc_init(void)    
{
    ...
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFPL &= ~((0xful << (24)) | (0xful << (28)));
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFPL |= (0x1UL<<(24)) | (0x1UL<<(28)) ;
	
     
    ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DINOFF |= ((0x00000040)<<16));	
    ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)))->DINOFF |= ((0x00000080)<<16));	
...
void ADC_FunctionTest()
{
   ...
   
    {
        ...
        if(u8Option)  
        {
            ...
            ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<(10)), (0UL<<(2)), 0x00008000);
        ...
        else  
        {
		   ...
		   ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<(10)), (0UL<<(2)), 0x00004000);
		   ...
		   i32ConversionData = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(14)] & (0xfffful << (0)));
