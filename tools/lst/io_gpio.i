...
void TYM_gpio_init(void)
{
	...
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFPL = (0x8UL<<(12)) | (0x8UL<<(8)) | (0x1UL<<(28));
...
void TYM_gpio_adc_get(uint32_t adc_channel)
{
	...
	for(u8ChannelCount = 0; u8ChannelCount < 16; u8ChannelCount++)
	{
		...
		{
			Global_datas.ADC_ChannelValue[u8ChannelCount] = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(u8ChannelCount)] & (0xfffful << (0)));
