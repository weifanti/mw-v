#line 1 "..\\src\\driver\\drv_5.8g_dwhp83.c"
...
#line 10 "..\\src\\driver\\drv_5.8g_dwhp83.c"
...
#line 11 "..\\src\\driver\\drv_5.8g_dwhp83.c"
...
#line 12 "..\\src\\driver\\drv_5.8g_dwhp83.c"
...
#line 13 "..\\src\\driver\\drv_5.8g_dwhp83.c"
...
{
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((9)<<2)))) = 0;  
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) = 1;  
    TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 100000);	
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((9)<<2)))) = 1;
...
void drv_DWHP83_unpairing_set(void)
{
    ...
    Hal_I2c_Transfer((0x80), (uint8_t*)arr_unpairing,  sizeof(arr_unpairing), (uint8_t*)0, 0);
}
...
{
    TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 100000);	
    Hal_I2c_Transfer((0x80), (uint8_t*)arr_clear_pairing_data,  sizeof(arr_clear_pairing_data), (uint8_t*)0, 0);
}
...
void drv_get_dwhp83_status(void)
{
    ...
    TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 100000);	
    dwhp83_status = I2C_ReadByteOneReg(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), (0x80),  0x3e);
...
void drv_Dwhp83_Init(void)
{
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00000400, 0x1UL);	
