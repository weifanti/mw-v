...
#line 12 "..\\lib\\StdDriver\\src\\fmc.c"
...
#line 13 "..\\lib\\StdDriver\\src\\fmc.c"
...
{
    if(i32BootSrc)
        ((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCTL |= (0x1ul << (1));  
    else
        ((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCTL &= ~(0x1ul << (1)); 
}
...
void FMC_DisableLDUpdate(void)
{
    ((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCTL &= ~(0x1ul << (5));
}
...
void FMC_EnableFreqOptimizeMode(uint32_t u32Mode)
{
    ((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->FTCTL &= ~(0x7ul << (4));
    ((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->FTCTL |= (u32Mode << (4));
}
