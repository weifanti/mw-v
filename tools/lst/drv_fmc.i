...
void hal_fmc_init(void)
{
    ...
    if (set_data_flash_base(0x03f800) < 0)
    {
...
void DataRead(void)
{
	...
	temp_data = FMC_Read(0x03f800);
	Global_datas.FmData.station_num = (temp_data & 0xff);

	temp_data = FMC_Read(0x03f804);
