...
#line 46 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
#line 47 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
#line 48 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
#line 49 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
#line 50 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
#line 1 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"
...
#line 90 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"
...
#line 113 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"
...
#line 183 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"
...
#line 248 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"

#line 274 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"
...
typedef struct
{
    ...
    uint8_t echoFlag; 
    uint8_t equalierFlag; 
    uint8_t exciterFlag; 
    uint8_t diversityFlag; 
    uint8_t pilotFlag; 
    uint8_t echoDepth;
    uint8_t echoDelay;
...
#line 314 "..\\src\\driver\\include\\drv_KT_WirelessMicRx.h"
...
void  KT_WirelessMicRx_SetMaxRfGain(uint8_t sel);
void KT_WirelessMicRx_chipPowerOn(void);

void KT_WirelessMicRx_Volume_set(uint8_t cVolume, uint8_t chipnum);


#line 51 "..\\src\\driver\\drv_KT_WirelessMicRx.c"

#line 60 "..\\src\\driver\\drv_KT_WirelessMicRx.c"

uint8_t chipSel;
uint8_t Flag_PKGSYNC[2]; 

uint8_t MorSSelect=1;


strI2s chipAI2sConfig={1,0,0,1,1,1,2};
strI2s chipBI2sConfig={1,0,1,1,0,1,2};
...
void KT_Bus_Write(uint16_t Register_Address, uint8_t Byte_Data,uint8_t chipNum)
{
    switch(chipNum)
    {
#line 122 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
        case 0: I2C_WriteByteTwoRegs(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0x39,Register_Address,Byte_Data);break;
        case 1: I2C_WriteByteTwoRegs(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0x31,Register_Address,Byte_Data);break;
...
uint8_t KT_Bus_Read(uint16_t Register_Address,uint8_t chipNum)
{
    ...
    switch(chipNum)
    {
#line 161 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
        ...
        case 0: 
			...
			data = I2C_ReadByteTwoRegs(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0x39, Register_Address);
        ...
        case 1: 
			...
			return( I2C_ReadByteTwoRegs(((I2C_T *) ((( uint32_t)0x40100000) + 0x20000)), 0x31, Register_Address) );
...
_Bool KT_WirelessMicRx_Volume(uint8_t cVolume)
{
    uint8_t regx;
...
_Bool KT_WirelessMicRx_PreInit(void)              
{
    uint8_t regx;
    uint8_t i;
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        regx = KT_Bus_Read(0x0192,chipSel);        
   
        if (regx == 0x4B)
        {

			regx=KT_Bus_Read(0x002d,chipSel); 
		    KT_Bus_Write(0x002d,(regx & ~0x04)|(1<<2),chipSel);
...
_Bool KT_WirelessMicRx_Init(void)
{
    uint8_t regx;
    ...
    KT_Bus_Write(0x0108,(regx&0x1f)|(0<<7)|(1<<6)|(0<<5),chipSel); 

	regx = KT_Bus_Read(0x001f,chipSel); 
	KT_Bus_Write(0x001f,(regx&0x1f)|0x40,chipSel); 

	KT_Bus_Write(0x000d,0xcf,chipSel); 

	
	KT_Bus_Write(0x0109,0x90,chipSel); 
    ...
    KT_Bus_Write(0x0082,0x89,chipSel); 
	
    regx=KT_Bus_Read(0x0081,chipSel);
    KT_Bus_Write(0x0081,(regx & 0x8f) | (1<<6) |
                 (1<<5) | (1<<4), chipSel); 

    KT_Bus_Write(0x0079,0x78,chipSel); 
    KT_Bus_Write(0x007a,0x80,chipSel); 

	regx=KT_Bus_Read(0x0201,chipSel);
    KT_Bus_Write(0x0201,regx|0x80,chipSel); 


    regx=KT_Bus_Read(0x0100,chipSel);

    KT_Bus_Write(0x0100,(regx & 0xDF) | (1<<5),chipSel); 
...
#line 365 "..\\src\\driver\\drv_KT_WirelessMicRx.c"

    
    regx = KT_Bus_Read(0x241,chipSel);          
    KT_Bus_Write(0x241,(regx & 0x3f) | (1<<7)|(1<<6),chipSel); 
    regx = KT_Bus_Read(0x243,chipSel);          
    KT_Bus_Write(0x243,(regx & 0x88) | (3<<4)| 4,chipSel); 
    regx = KT_Bus_Read(0x245,chipSel);          
    KT_Bus_Write(0x245,0x22,chipSel); 

    regx = KT_Bus_Read(0x0200,chipSel);          
    KT_Bus_Write(0x0200,(regx&0x8f)|(1<<4),chipSel); 
    ...
    KT_Bus_Write(0x0217,(regx&0x3f)|(2<<6)|0x01,chipSel);	

	KT_Bus_Write(0x0218,0x02,chipSel); 
...
#line 419 "..\\src\\driver\\drv_KT_WirelessMicRx.c"

	regx=KT_Bus_Read(0x0030,chipSel);
	KT_Bus_Write(0x0030,regx & ~0x80,chipSel);




    regx = KT_Bus_Read(0x0133,chipSel);          
    KT_Bus_Write(0x0133,(regx|0x40),chipSel); 
	...
	regx = KT_Bus_Read(0x0108,chipSel);          
    KT_Bus_Write(0x0108,(regx|0x10),chipSel); 
	while(1)
	{		
...
#line 483 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
#line 532 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
    
	regx=KT_Bus_Read(0x0108,chipSel);
    KT_Bus_Write(0x0108,regx & ~0x08,chipSel); 
    ...
    regx=KT_Bus_Read(0x0047,chipSel);
    KT_Bus_Write(0x0047,regx | 0x01,chipSel); 
	...
	if(KT_Bus_Read(0x010f,chipSel)==0x10)
	{
		...
		regx=KT_Bus_Read(0x0042,chipSel);
		KT_Bus_Write(0x0042,regx | 0x10,chipSel);

		regx=KT_Bus_Read(0x0030,chipSel);
		LO_LOCK_DET_PD_SAVE = regx&0x80;
		KT_Bus_Write(0x0030,regx | 0x80,chipSel);
	   
		regx=KT_Bus_Read(0x0017,chipSel); 
		state=regx&0x07;
		if(state >= 3)
		{
			state = 7;                                
		...
		KT_Bus_Write(0x0017, regx,chipSel); 
		...
		regx=KT_Bus_Read(0x0030,chipSel);
		KT_Bus_Write(0x0030,(regx & ~0x80)|LO_LOCK_DET_PD_SAVE,chipSel);

	
	

		if(KT_WirelessMicRx_GetSNR()>0x78)
		{
			regx=KT_Bus_Read(0x0087,chipSel);			
			KT_Bus_Write(0x0087,regx&~0x02,chipSel);
		}
	}
#line 625 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
}
...
#line 650 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
    ...
    while (!(KT_Bus_Read(0x0061,chipSel) & 0x01)); 
#line 689 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
	if(KT_WirelessMicRx_GetSNR()>0x78)
	{
		regx=KT_Bus_Read(0x0087,chipSel);			
		KT_Bus_Write(0x0087,regx&~0x02,chipSel);
...
void KT_WirelessMicRx_SW_Echo(uint8_t cEcho_En)
{
    ...
    KT_Bus_Write(0x0266,(regx & 0x08) | (cEcho_En<<7) | (1<<6) | 
                 (0<<4) | (7<<0),chipSel);
}
...
void KT_WirelessMicRx_SW_Exciter(uint8_t cExciter_En)
{
    ...
    KT_Bus_Write(0x0269,(regx & 0x18) | (cExciter_En<<7) | (2<<5) | 
                 (0<<0),chipSel);
}
...
void KT_WirelessMicRx_CheckAUXCH(void)
{
    ...
    if(MorSSelect)
	{
	    ...
	    if(regx&0x10) 
	    {
	        ...
	        regx = KT_Bus_Read(0x0209,chipSel);
	        if(regx&0x40)
	            Flag_PKGSYNC[chipSel] = 1;
	        else
	            Flag_PKGSYNC[chipSel] = 0;
	    }
	}
#line 1021 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
}
...
#line 1047 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
static void Pll_Band_Cali(uint8_t CLl, uint8_t CLh)
{
	...
	regx=KT_Bus_Read(0x001c,chipSel); 
    KT_Bus_Write(0x001c, regx|0x40 ,chipSel);
	...
	regx=KT_Bus_Read(0x0061,chipSel); 
    KT_Bus_Write(0x0061, regx|0x02 ,chipSel);

    regx=KT_Bus_Read(0x0016,chipSel); 
    KT_Bus_Write(0x0016, regx|0x80 ,chipSel);
	...
	{
		KT_Bus_Write(0x001e, CLl ,chipSel);
	}
	else
	{
		KT_Bus_Write(0x001e, loVcoBandSelRead-5 ,chipSel);
	}    

	regx=KT_Bus_Read(0x0042,chipSel); 
    KT_Bus_Write(0x0042, regx&~0x20 ,chipSel);

	regx=KT_Bus_Read(0x0061,chipSel);
    KT_Bus_Write(0x0061, regx|0x40 ,chipSel);  
    
    
    while(!(0x80&KT_Bus_Read(0x0064,chipSel)));
    ...
    while(1)
    {      
        regx=KT_Bus_Read(0x001e,chipSel); 
...
static void PLL_Reset(void)
{
    ...
    if(0x08&KT_Bus_Read(0x00133,chipSel))	  
    {
        regx=KT_Bus_Read(0x0016,chipSel);  
		Tmp = (regx>>6)&0x01;

        VrefSel = 0x07&KT_Bus_Read(0x0016,chipSel);
		...
		regx&=~0x07;
		regx|=regy;
		KT_Bus_Write(0x0018, regx ,chipSel);  
		
		regx=KT_Bus_Read(0x0016,chipSel);
		KT_Bus_Write(0x0016, regx|0x40 ,chipSel); 	
		...
		regx=KT_Bus_Read(0x0018,chipSel);
		KT_Bus_Write(0x0018, (regx&0xf8)|VrefSel ,chipSel);  
    }
}
...
void KT_WirelessMicRx_SelectMS(void)
{
#line 1264 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
		MorSSelect=1;
...
{
	uint8_t regx;
	for(chipSel=0;chipSel<2;chipSel++)
	{
		if(KT_Bus_Read(0x010f,chipSel)==0x10)
		{
...
static void  snrMuteRefresh(void)
{
	...
	for(chipSel=0;chipSel<2;chipSel++)
	{
		if(KT_Bus_Read(0x010f,chipSel)==0x10)
		{
			if(((KT_Bus_Read(0x0100,chipSel)&0x20)==0x20)&&(KT_Bus_Read(0x020D,chipSel)<=0x78))
			{
				regx=KT_Bus_Read(0x0087,chipSel);
				KT_Bus_Write(0x0087,(regx|0x02),chipSel);
			}
			else if((KT_Bus_Read(0x020D,chipSel)>=0x80)||((KT_Bus_Read(0x0100,chipSel)&0x20)==0x00))
			{
				regx=KT_Bus_Read(0x0087,chipSel);
				KT_Bus_Write(0x0087,(regx&~0x02),chipSel);
			}
...
#line 1434 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
	regx=KT_Bus_Read(0x0108,chipSel);
    KT_Bus_Write(0x0108,regx | 0x08,chipSel); 
...
#line 1712 "..\\src\\driver\\drv_KT_WirelessMicRx.c"


#line 1802 "..\\src\\driver\\drv_KT_WirelessMicRx.c"
...
void KT_WirelessMicRx_chipPowerOn(void)
{
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 0x00000400, 0x1UL);
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((10)<<2)))) = 0;
	TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 5000); 
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((10)<<2)))) = 1;
    TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 15000);	
    
	for(chipSel=0;chipSel<2;chipSel++)
    {
        while(!KT_WirelessMicRx_PreInit()); 
    }
    TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 200000);	
