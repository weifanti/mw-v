...
#line 24 "..\\src\\io\\io_ii2c.c"
#line 1 "..\\src\\io\\include\\io_ii2c.h"
...
void nop(void)
{
    TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 10);	
}
...
{  
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 0x00000020, 0x0UL);
	...
	while ( (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((5)<<2)))) ) 
	{
		I2CDelay();  
		if ( ( outtime++ )>250 ) 
		{
...
{  
    ...
    {  
        ...
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((5)<<2)))) = (sendData>>(7 - serialNum))&0x01;  
...
{     
    ...
    {  
        ...
        if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((5)<<2))))) 
        {
