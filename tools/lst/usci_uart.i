...
#line 13 "..\\lib\\StdDriver\\src\\usci_uart.c"
...
#line 14 "..\\lib\\StdDriver\\src\\usci_uart.c"
...
uint32_t UUART_Open(UUART_T* uuart, uint32_t u32baudrate)
{
    ...
    if((uuart == ((UUART_T *) ((( uint32_t)0x40000000) + 0x70000))) || (uuart == ((UUART_T *) ((( uint32_t)0x40000000) + 0x74000))))
    {
