...
#line 14 "..\\src\\driver\\drv_ irkey.c"
...
#line 15 "..\\src\\driver\\drv_ irkey.c"
...
#line 16 "..\\src\\driver\\drv_ irkey.c"
...
{ 
  ...
  for(i=0;i<4;i++)      
	 ...
	 if((ir_code[0] == 0x12) && (ir_code[1] == 0x34))
	 {
		key_value = ir_code[2];
	 ...
	 else if((ir_code[0] == 0x0c) && (ir_code[1] == 0xf3))
	 {
		key_value = ir_code[2];
