#line 1 "..\\src\\driver\\drv_dap_5548.c"
...
#line 10 "..\\src\\driver\\drv_dap_5548.c"
...
#line 11 "..\\src\\driver\\drv_dap_5548.c"
...
#line 12 "..\\src\\driver\\drv_dap_5548.c"

#line 1 "..\\src\\driver\\include\\drv_dap_5548.h"
...
#line 14 "..\\src\\driver\\drv_dap_5548.c"
...
#line 15 "..\\src\\driver\\drv_dap_5548.c"
#line 1 "..\\src\\driver\\include\\drv_dap_5548_param.h"
...
#line 16 "..\\src\\driver\\drv_dap_5548.c"
...
static void drv_5548_i2c_write(cfg_reg *r, int n)
{
        ...
        while (i < n) {
            ...
            case (253):
				...
				Hal_I2c_Transfer((0x34), (unsigned char *)&r[i+1],  r[i].param, (uint8_t*)0, 0);
                i += (r[i].param + 1)/2;
                break;
            default:
				
				Hal_I2c_Transfer((0x34), (uint8_t *)&r[i], 2, (uint8_t*)0, 0);
...
void Hal_Dap_Load_vol_add(void)
{
    ...
    Hal_I2c_Transfer((0x34), (uint8_t*)init_arr_0xD9, sizeof(init_arr_0xD9), (uint8_t*)0, 0);
}
...
void Hal_Dap_Init(void)
{
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0140)), 0x00000004, 0x1UL);
	...
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5))) + ((2)<<2)))) = 1; 
...
void drv_Dap_Load_out_Param(void)
{
	...
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(5))) + ((2)<<2)))) = 0;
