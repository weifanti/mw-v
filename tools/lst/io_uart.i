...
void UART0_Init()
{
    ...
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->BAUD = ((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((115200)/2)) / (115200))-2);
...
void UART1_Init()
{
    ...
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 |=  (0x1ul << (17));
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 &= ~(0x1ul << (17));

     
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->BAUD = ((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((19200)/2)) / (19200))-2);
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LINE = (3) | (0x0 << (3)) | (0x0 << (2));
}

void UART2_Init()
{
     
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 |=  (0x1ul << (18));
    ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 &= ~(0x1ul << (18));

     
    ((UART_T *) ((( uint32_t)0x40100000) + 0x54000))->BAUD = ((0x1ul << (29)) | (0x1ul << (28))) | (((((12000000UL)) + ((115200)/2)) / (115200))-2);
    ((UART_T *) ((( uint32_t)0x40100000) + 0x54000))->LINE = (3) | (0x0 << (3)) | (0x0 << (2));
	Hal_Uart2_Data_Init();
}
...
void UART_4G_HANDLE(void)
{
	...
	UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)), (0x1ul << (0)));

	if((((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->INTSTS & (0x1ul << (0)))>>(0)))
    {
...
int32_t Debug_Uart_Init(void)
{
    ...
    UART_EnableInt(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), (0x1ul << (0)) );
...
#line 411 "..\\src\\io\\io_uart.c"
	for(temp3 = 0; temp3 < len; temp3++)
	{
		...
		TIMER_Delay(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), 2000);
