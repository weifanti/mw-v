...
#line 12 "..\\src\\core\\core.c"
#line 1 "..\\src\\core\\include\\core.h"
...
void Core_Int_Get(void)
{
    int_mask = (((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0U]);
...
{
	Core_Int_Get();
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICER[0U] = 0xFF;
...
void Core_Int_Restore(void)
{
    ...
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0U] = int_mask|0x20;
