...
#line 4 "..\\src\\global\\hal_timer0.c"
...
#line 6 "..\\src\\global\\hal_timer0.c"


#line 9 "..\\src\\global\\hal_timer0.c"

#line 11 "..\\src\\global\\hal_timer0.c"
...
#line 12 "..\\src\\global\\hal_timer0.c"
...
typedef struct _PowerStatus
{
	...
	unsigned char PowerBatExStatus;
...
#line 14 "..\\src\\global\\hal_timer0.c"
...
void Hal_Timer0_Init(void)
{
    ...
    TIMER_Open(((TIMER_T *) ((( unsigned int)0x40000000) + 0x10000)), (1UL << (27)), 10000); 

     
    TIMER_EnableInt(((TIMER_T *) ((( unsigned int)0x40000000) + 0x10000)));
...
void Hal_Timer1_Init(void)
{
    ...
    CLK_SetModuleClock(((((1) & 0x03) << 30)|((((3)) & 0x1f) << 0) | (((1) & 0x03) << 28)|(((7) & 0x07) << 25)|(((12) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x7UL<<(8)), 0);
	

    TIMER_Open(((TIMER_T *) ((( unsigned int)0x40000000) + 0x10100)), (1UL << (27)), 10000); 

     
    TIMER_EnableInt(((TIMER_T *) ((( unsigned int)0x40000000) + 0x10100)));
    NVIC_EnableIRQ(TMR1_IRQn);
    NVIC_SetPriority(TMR1_IRQn, 1);


    
    TIMER_Start(((TIMER_T *) ((( unsigned int)0x40000000) + 0x10100)));
...
void TMR1_IRQHandler(void)
{
    ...
    TIMER_ClearIntFlag(((TIMER_T *) ((( unsigned int)0x40000000) + 0x10100)));
