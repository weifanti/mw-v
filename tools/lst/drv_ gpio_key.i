...
#line 14 "..\\src\\driver\\drv_ gpio_key.c"
...
#line 15 "..\\src\\driver\\drv_ gpio_key.c"
...
#line 16 "..\\src\\driver\\drv_ gpio_key.c"
...
void drv_gpio_key_handler(void);

void drv_gipo_key_init(void);

uint8_t drv_get_gpio_key_value(void);

#line 17 "..\\src\\driver\\drv_ gpio_key.c"
...
uint8_t gpio_key1_value_count = 0;
uint8_t gpio_key2_value_count = 0;
uint8_t gpio_key1_value_flag = 0;
uint8_t gpio_key2_value_flag = 0;
uint8_t gpio_key_value = 0;



void drv_gpio_key_status_change(void)
{
	if((gpio_key_status.key_status_back & 0x01) == (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((3)<<2)))))
	{
		...
		if(gpio_key1_change_flag == 1)
		{
			if(gpio_key_status.key1_count > 20)
			{
				...
				if(gpio_key_status.key_status_back & 0x01)
				{
					...
					gpio_key_status.key_status=GPIO_KEY_POWER_UP;
					
				}
				else
				{
					printf("GPIO_KEY_POWER_DOWN\n");
					gpio_key_status.key_status=GPIO_KEY_POWER_DOWN;
	...
	else
	{
		...
		gpio_key_status.key_status_back = (gpio_key_status.key_status_back & 0xfe) | (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((3)<<2))));
	}
	if(((gpio_key_status.key_status_back >> 1) & 0x01) == (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((6)<<2)))))
	{	
	
		
		if(gpio_key2_change_flag)
		{
			if(gpio_key_status.key2_count >0x10)
			{
				gpio_key2_change_flag = 0;
				if(gpio_key_status.key_status_back & 0x02)
				{
					printf("GPIO_KEY_MODE_UP\n");
					gpio_key_status.key_status=GPIO_KEY_MODE_UP;
					
				}
				else
				{
					printf("GPIO_KEY_MODE_DOWN\n");
					gpio_key_status.key_status=GPIO_KEY_MODE_DOWN;
	...
	else
	{
		...
		gpio_key_status.key_status_back = (gpio_key_status.key_status_back & 0xfd) | ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((6)<<2))))<<1);
	}
	
 	gpio_key_status.key_status=GPIO_KEY_STATUS_NONE;		
}
...
void drv_gpio_key_handler(void)
{
	...
	if(gpio_key_status.key_status==GPIO_KEY_POWER_UP)
	{	
		gpio_key1_value_flag = 1;
		
	printf("gpio_key1_value_flag = %x\n",gpio_key1_value_flag);
	}
	if(gpio_key_status.key_status==GPIO_KEY_POWER_DOWN)
	{	
		gpio_key1_value_flag = 0;
	printf("gpio_key1_value_flag = %x\n",gpio_key1_value_flag);
	}
	if(gpio_key1_value_flag)
	{
		gpio_key1_value_count++;
		
		printf("gpio_key1_value_count = %x\n",gpio_key1_value_count);
		if(gpio_key1_value_count > 0xe0)
		{
			gpio_key1_value_flag = 0;
			gpio_key1_value_count = 0;
			gpio_key_value = GPIO_KEY1_LONG;
	...
	{
		if(gpio_key1_value_count > 0x1)
		{
			gpio_key1_value_count = 0;
			gpio_key_value =  GPIO_KEY1_SHORT;
		printf("GPIO_KEY1_SHORT = %d\n",gpio_key_value);
		}
	}
	
	if(gpio_key_value != GPIO_KEY_VALUE_NONE)
	{
		printf("gpio_key_value = %d\n",gpio_key_value);
		
	}
	
	
	if(gpio_key_status.key_status==GPIO_KEY_MODE_DOWN)
	{	
		gpio_key2_value_flag = 1;
	printf("gpio_key2_value_flag = %x\n",gpio_key2_value_flag);
	}
	if(gpio_key_status.key_status==GPIO_KEY_MODE_UP)
	{	
		gpio_key2_value_flag = 0;
	printf("gpio_key2_value_flag = %x\n",gpio_key2_value_flag);
	}
	if(gpio_key2_value_flag)
	{
		gpio_key2_value_count++;
		printf("gpio_key1_value_count = %x\n",gpio_key1_value_count);
		if(gpio_key2_value_count > 0xe0)
		{
			gpio_key2_value_flag = 0;
	...
	gpio_key_value =  GPIO_KEY_VALUE_NONE;
