...
typedef enum {USA, EUROPE, JAPAN} country_enum; 
...
void FmIoConfig(void)
{
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00000800, 0x1UL);
...
void Fm_Rest(void)
{
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0100)), 0x00000800, 0x1UL); 

	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(4))) + ((11)<<2)))) = 1;
	for(i = 0UL; i < 200000 ; ++i)
	{
	   __nop();
	}
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(4))) + ((11)<<2)))) = 0;
	for(i = 0UL; i < 200000 ; ++i)
	{
	   __nop();
	}
...
void io2w_start(uint8_t io2w_address, uint8_t operation)
{
    ...
    for ( i = 7; i >= 0; i-- )
    {
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) = 0;
        wait_us(1); 
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) = ((io2w_address >> i) & 0x01);
        wait_us(1); 
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) = 1;
        wait_us(1); 
...
static void io2w_write_byte(uint8_t wrdata)
{
    ...
    for ( i = 7; i >= 0; i-- )
    {
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) = 0;
        wait_us(1); 
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))) = ((wrdata >> i) & 0x01);
        wait_us(2); 
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) = 1;
        wait_us(1); 
    }
...
static uint8_t io2w_read_byte(uint8_t remaining_bytes)
{
    ...
    for( i = 0; i < 8; i++ )
    {
        ...
        (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((11)<<2)))) = 1;
        wait_us(1);                      
        rddata = ((rddata << 1) | (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((10)<<2)))));
...
void si47xx_waitForCTS()
{
    ...
    while ((i--) && !(si47xx_readStatus() & 0x80))
    {
        wait_us(500);
    }
...
static void si47xxFMRX_hardware_cfg(void)
{
    ...
    si47xx_set_property(0x0001, 0x0001 | 0x0004);
}
...
static void si47xxFMRX_general_cfg(void)
{
      ...
      si47xx_set_property(0x1302, 0x1f);   
      si47xx_set_property(0x1303, 9);    
     ...
     si47xx_set_property(0x1403, 3);
     si47xx_set_property(0x1404, 16);   
}
...
void si47xxFMRX_regional_cfg(country_enum country)
{
    ...
    case USA :
        ...
        si47xx_set_property(0x1500, 
					0x0004); 

		
        
        si47xx_set_property(0x1502, 0x0001 |
			(3 << 14) |
			(3 << 12) |
			(3 << 10) |
			(3 << 8));

        si47xx_set_property(0x1100, 0x2); 
        
        
        break;
    case JAPAN :
        si47xx_set_property(0x1502, 0);              
        si47xx_set_property(0x1100, 0x1); 
        si47xx_set_property(0x1400, 7600);     
        si47xx_set_property(0x1401, 9000);        
        si47xx_set_property(0x1402, 10);      
        break;
    case EUROPE :
    default:
...
void si47xxFMRX_set_volume(uint8_t volume)
{
    ...
    si47xx_set_property(0x4001, 0);

    
    si47xx_set_property(0x4000, (uint32_t)volume & 0x003F);
}
...
uint8_t si47xxFMRX_seek(uint8_t seekup, uint8_t seekmode)
{
    ...
    while (WaitSTCInterrupt); 

    
    
    
    
    while (!(getIntStatus() & 0x01));
...
uint8_t IsStationNumValid(void)
{
	if(Global_datas.FmData.station_num <= 15)
		return 1;
	else return 0;
}
...
uint8_t IsCurrentStationNunValid(void)
{
	if((Global_datas.FmData.current_station <= 15) && (Global_datas.FmData.current_station <= Global_datas.FmData.station_num))
		return 1;
	else return 0;
}
