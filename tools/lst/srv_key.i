...
#line 14 "..\\src\\server\\key\\srv_key.c"
...
#line 15 "..\\src\\server\\key\\srv_key.c"
...
#line 17 "..\\src\\server\\key\\srv_key.c"
...
#line 18 "..\\src\\server\\key\\srv_key.c"
...
#line 19 "..\\src\\server\\key\\srv_key.c"
...
#line 20 "..\\src\\server\\key\\srv_key.c"
...
void srv_key_mode_handler(void)
{
	switch(Global_datas.g_mode_status)
	{
		...
		case LOUD_SPEAKER_MODE:
			...
			drv_Cmd_Send2NCU031(0x07, 0x10,0x00);
		break;
		...
		case FOURG_CONNECTED_MODE:
			...
			drv_Cmd_Send2NCU031(0x07, 0x12,0x00);
	    ...
	    case BT_CONNECTED_MODE:
			...
			drv_Cmd_Send2NCU031(0x07, 0x11,0x00);
		break;
...
{
	Core_Msg_Send(MSG_MCU1_SYS_STATE_IND, 0x03,0x02,0x00); 
}

void srv_key_volume_down_handler(void)
{
	Core_Msg_Send(MSG_MCU1_SYS_STATE_IND, 0x03,0x03,0x00); 
}
...
void srv_key_prev_station_handler(void)
{
	...
	Core_Msg_Send(MSG_MCU1_SYS_STATE_IND, 0x03,0x32,0x00); 
}
...
{
	Core_Msg_Send(MSG_MCU1_SYS_STATE_IND, 0x03,0x21,0x00); 
}
