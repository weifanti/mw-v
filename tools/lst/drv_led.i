...
void drv_led_init(void)
{
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0x00008000, 0x1UL);  
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0140)), 0x00000040, 0x1UL);   
