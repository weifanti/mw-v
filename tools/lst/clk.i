...
#line 12 "..\\lib\\StdDriver\\src\\clk.c"
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL |= (0x1ul << (2));
    CLK_WaitClockReady((0x1ul << (4)));
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (~(0x7ul << (0)))) | (0x07UL<<(0));
...
lexit:
    ...
    if(u32PllClkSrc == 0x00000000UL)
        ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCTL = (0x00000000UL | (((4)-2)<<9) | ((48)-2) | 0x4000UL);  
    else
        ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCTL = (0x00080000UL | (((8)-2)<<9) | ((52)-2) | 0x4000UL);  
