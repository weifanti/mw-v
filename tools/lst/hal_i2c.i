...
#line 14 "..\\src\\io\\hal_i2c.c"
#line 1 "..\\src\\core\\include\\tym_global.h"
...
void Hal_I2c_Init(void)
{
    ...
    I2C_Open(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), (100000UL));
...
void I2C0_IRQHandler(void)
{
    ...
    if(i2c_trans_data.next_status != status)
    {
        ...
        if(i2c_trans_data.wait_cnt > (500))
        {
            if((sys_err & SYS_ERR_I2C0) == 0)
            {
                sys_err |= SYS_ERR_I2C0;
