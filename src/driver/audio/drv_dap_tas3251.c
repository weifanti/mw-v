...
// {0x44, 0x02, 0x81, 0x85, 0x08},   //14
 ...
 { 
	 ...
	 {0x44, 0x00, 0x01, 0x47, 0xae},  // -40db
	 {0x44, 0x00, 0x04, 0x0c, 0x37},   // -30db
	 {0x44, 0x00, 0x07, 0x32, 0xae},  // -25
	 {0x44, 0x00, 0x0c, 0xcc, 0xcd},   // -20db
	 {0x44, 0x00, 0x16, 0xc3, 0x11},   // -15
	 {0x44, 0x00, 0x28, 0x7a, 0x27},   // -10
	 {0x44, 0x00, 0x32, 0xf5, 0x2d},   //-8
	 {0x44, 0x00, 0x40, 0x26, 0xe7},   //-6
	 {0x44, 0x00, 0x50, 0xc3, 0x36},   //-4
 ...
 { 
	 ...
	 {0x48, 0x00, 0x07, 0x32, 0xae},  // -25
	 {0x48, 0x00, 0x0c, 0xcc, 0xcd},   // -20db
	 {0x48, 0x00, 0x16, 0xc3, 0x11},   // -15
	 ...
	 {0x48, 0x00, 0xca, 0xdd, 0xc8},   //4db
	 {0x48, 0x00, 0xff, 0x64, 0xc1},   //6
	 {0x48, 0x01, 0x41, 0x85, 0x7f},   //8
 ...
 { 
	 ...
	 {0x44, 0x00, 0x00, 0x10, 0x6c},  // -66db
	 {0x44, 0x00, 0x00, 0x33, 0xef},  // -56db
	 {0x44, 0x00, 0x00, 0xa4, 0x3b},  // -46db
	 {0x44, 0x00, 0x02, 0x07, 0x56},   // -36db
	 {0x44, 0x00, 0x03, 0x9b, 0x87},  // -31
	 {0x44, 0x00, 0x06, 0x6a, 0x4a},   // -26db
	 {0x44, 0x00, 0x0b, 0x68, 0x73},   // -21
	 {0x44, 0x00, 0x14, 0x49, 0x61},   // -16
	 {0x44, 0x00, 0x19, 0x8a, 0x13},   //-14
	 {0x44, 0x00, 0x20, 0x26, 0xf3},   //-12
	 {0x44, 0x00, 0x28, 0x7a, 0x27},   // -10
	 {0x44, 0x00, 0x32, 0xf5, 0x2d},   //-8
	 {0x44, 0x00, 0x40, 0x26, 0xe7},   //-6
	 {0x44, 0x00, 0x50, 0xc3, 0x36},   //-4
 ...
 { 
	 ...
	 {0x48, 0x00, 0x00, 0x10, 0x6c},  // -66db
	 {0x48, 0x00, 0x00, 0x33, 0xef},  // -56db
	 {0x48, 0x00, 0x00, 0xa4, 0x3b},  // -46db
	 {0x48, 0x00, 0x02, 0x07, 0x56},   // -36db
	 {0x48, 0x00, 0x03, 0x9b, 0x87},  // -31
	 {0x48, 0x00, 0x06, 0x6a, 0x4a},   // -26db
	 {0x48, 0x00, 0x0b, 0x68, 0x73},   // -21
	 {0x48, 0x00, 0x14, 0x49, 0x61},   // -16
	 {0x48, 0x00, 0x19, 0x8a, 0x13},   //-14
	 {0x48, 0x00, 0x20, 0x26, 0xf3},   //-12
	 {0x48, 0x00, 0x28, 0x7a, 0x27},   // -10
	 {0x48, 0x00, 0x32, 0xf5, 0x2d},   //-8
	 {0x48, 0x00, 0x40, 0x26, 0xe7},   //-6
	 {0x48, 0x00, 0x50, 0xc3, 0x36},   //-4
...
{
	drv_dap_3251_i2c_write(tas3251_volume_page,sizeof(tas3251_volume_page)/2);
	Hal_I2c_Transfer(DAP_I2C_ADDR, (uint8_t*)tas3251_44volume_wifi_bt[value], 5, (uint8_t*)NULL, 0);
	drv_dap_3251_i2c_write(tas3251_volume_page,sizeof(tas3251_volume_page)/2);
	Hal_I2c_Transfer(DAP_I2C_ADDR, (uint8_t*)tas3251_48volume_wifi_bt[value], 5, (uint8_t*)NULL, 0);
	drv_dap_3251_i2c_write(tas3251_cmd_cfm,sizeof(tas3251_cmd_cfm)/2);
}
